...
#   |    Realisation : ALKHOURI George  -  TOUATI Mounia     
...
#________________________________________________________________METHODES POUR L'ALGORITHMES GENETIQUE___________________________________________________________________
...
def algo_Genetique(Coords, taillep, n_generation, mutation_rate, taille_tournament, num_parent):
    ...
    for gen in range(n_generation):  # itérer sur le nombre de générations spécifié par n_generation
        ...
        print(f"Génération {gen + 1}: Meilleur Individu: {best_individu_gen}, Fitness: {best_fitness_gen:.19f}")
...
#_______________________________________________________________________INTERFACE GRAPHIQUE_______________________________________________________________________________
...
#____________________________________________________________MAIN___________________________________________________________________
